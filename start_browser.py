...
class StartBrowser:
    ...
    def profile(self):
        ...
        elements_profile = len(self._driver.find_elements_by_xpath(
            '//div[7]/div/div[9]/div[1]/div/div[2]/div[2]/div/div/div/div/div/div[1]/a'))
        page = 2
        url = ''
        ...
        self._driver.get(
            'https://www.google.com/search?q=site:linkedin.com/in/+AND+%22desarrollador%22+AND+%22Corporacion+Universitaria+del+Caribe%22&ei=7o29YPTPI-Oq5NoPhfe3gAs&start=0&sa=N&ved=2ahUKEwj0_tb3xYTxAhVjFVkFHYX7DbA4KBDy0wN6BAgBEDo&biw=1440&bih=757')
        page = 2
        elements_profile = len(self._driver.find_elements_by_xpath(
            '//div[7]/div/div[9]/div[1]/div/div[2]/div[2]/div/div/div/div/div/div[1]/a'))
        while page < 30:
        ...
        self._driver.get(
            'https://www.google.com/search?q=site:linkedin.com/in/+AND+%22ingeniero+de+sistemas%22+AND+%22Corporaci%C3%B3n+Universitaria+del+Caribe%22&ei=uM3CYKjTKsCl5NoPiKaggA4&start=0&sa=N&ved=2ahUKEwioj768x47xAhXAElkFHQgTCOA4FBDy0wN6BAgBEDo&biw=1440&bih=757')
        page = 2
        elements_profile = len(self._driver.find_elements_by_xpath(
            '//div[7]/div/div[9]/div[1]/div/div[2]/div[2]/div/div/div/div/div/div[1]/a'))
        while page < 30:
